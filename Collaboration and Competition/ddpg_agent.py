...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, n_agents, fc1_units=256, fc2_units=128):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, n_agents, fcs1_units=256, fc2_units=128):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
...
class Agent():
    ...
    def __init__(self, state_size, action_size, n_agents, seed):
        ...
        self.actor_local = Actor(state_size, action_size, seed, n_agents).to(device)
        self.actor_target = Actor(state_size, action_size, seed, n_agents).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, seed, n_agents).to(device)
        self.critic_target = Critic(state_size, action_size, seed, n_agents).to(device)
